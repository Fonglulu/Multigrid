...
# -*- coding: utf-8 -*-
"""
Created on Mon May 20 15:50:22 2019
...
#############################################################################
# This is an important rountine!!!
# Gives correct A, G1, G2 matrices
# Always check with those ones
#############################################################################
...
for node in node_iterator(grid):
    ...
    # If the node is a slave node, its value should be given by the boundary condition
        ...
        node.set_value(linear(node.get_coord()))
#        
#
